...
static struct s_varmap {
	...
	{"federation_reiteration", PT_bool, &global_federation_reiteration, PA_REFERENCE, "global boolean to inforce a reiteration for all modules due to an external federation reiteraion"},
